...
class ServiceProvider extends \Illuminate\Support\ServiceProvider {
	...
	public function boot(Router $router)
	{
		...
		{
			$router->get('/',         [ 'as' => static::PREFIX . '::news',      'uses' => static::CONTROLLER . '@index' ]);
			$router->get('index',     [ 'as' => static::PREFIX . '::news',      'uses' => static::CONTROLLER . '@index' ]);
			$router->get('item/{id}', [ 'as' => static::PREFIX . '::news-item', 'uses' => static::CONTROLLER . '@item' ]);
